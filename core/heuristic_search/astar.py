...
from core.heuristic_search.node import Node
from core.Problem import Problem
from core.heuristic_search.pqueue import PriorityQueue
...
def astar(problem:Problem):
    ...
    while not front.empty():
        ...
        if problem.goal(current_state):
            ...
            return current_node.path(), numExpansions  # solution found!
        else:
